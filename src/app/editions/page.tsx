...
export default async function Editions() {
  ...
  return (
    <>
      ...
      {/* === EDITION 03 — link banner (full landing page) === */}
      <EditionBanner
        variant="link"
        href="/editions/03"
      ...
      {/* === EDITION 02 — dropdown banner (intro + 16 designer cards) === */}
      <EditionBanner
        variant="dropdown"
      ...
      >
        ...
        {/* Edition 02 — designer Specimen Plates */}
      ...
      {/* === EDITION 01 — dropdown banner (retrospective) === */}
      <EditionBanner
        variant="dropdown"
